        ...
        public void ManejadorVoto(string senador, Votacion.EVoto voto)
        {
            ...
            else
            {
                ...
                if (aux == 0)
                {
                      ...
                      // Guardar resultados
                      SerializarXML<Votacion> vot = new SerializarXML<Votacion>();
                      vot.Guardar(AppDomain.CurrentDomain.BaseDirectory+"SerializacionXml.xml",votacion);
                      Dao dao = new Dao();
                      dao.Guardar("sarasa",votacion);
